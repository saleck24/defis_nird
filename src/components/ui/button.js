...
function Button(_a) {
    var { className, variant, size, asChild = false } = _a, props = Object.assign({}, _a);
    const Comp = asChild ? react_slot_1.Slot : "button";
    return React.createElement(Comp, Object.assign({ "data-slot": "button", className: (0, utils_1.cn)(buttonVariants({ variant, size, className })) }, props));
}
