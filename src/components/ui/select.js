...
function SelectTrigger({
  ...
  return React.createElement(
    ...
    [
      children,
      React.createElement(SelectPrimitive.Icon, { asChild: true, key: "icon" },
...
function SelectContent({
  ...
  return React.createElement(SelectPrimitive.Portal, null,
    React.createElement(SelectPrimitive.Content, {
      ...
      React.createElement(SelectScrollUpButton, { key: "up" }),
      ...
      React.createElement(SelectScrollDownButton, { key: "down" }),
    ])
  );
}
...
function SelectItem({
  ...
  return React.createElement(
    ...
    [
      ...
      React.createElement(SelectPrimitive.ItemText, { key: "text" }, children),
    ]
  );
}
